...
import { AddWorkToOrderCommand, AssignWorkToWorkerCommand } from '../commands/index.js'
...
describe('AddWorkToOrderCommandHandler', () => {
  describe('execute', () => {
    ...
    beforeEach(() => {
      ...
      const orderRepository = new OrderRepository({} as EventStoreRepository, {} as AggregateSnapshotRepository)
