...
export class WorkAggregate extends Aggregate {
  ...
  constructor(snapshot: Snapshot<WorkAggregate> = null) {
    if (!snapshot) {
      super()
    } else {
      ...
      if (snapshot.state) {
        ...
        this.estimate = snapshot.state.estimate
        this.status = snapshot.state.status
        this.assignedTo = snapshot.state.assignedTo
        this.orderID = snapshot.state.orderID
      }
    }
  }
  ...
  replayWorkCreatedV1(event: WorkCreatedV1) {
    this.id = event.id
  ...
  replayWorkTitleChangedV1(event: WorkTitleChangedV1) {
    this.title = event.title
  ...
  replayWorkDescriptionChangedV1(event: WorkDescriptionChangedV1) {
    this.description = event.description
  ...
  replayWorkEstimateSetV1(event: WorkEstimateSetV1) {
    this.estimate = event.estimate
  ...
  replayWorkStatusChangedV1(event: WorkStatusChangedV1) {
    this.status = event.status
  ...
  replayWorkAssignedToWorkerV1(event: WorkAssignedToWorkerV1) {
    this.assignedTo = event.workerID
  ...
  replayWorkUnassignedFromWorkerV1() {
    this.assignedTo = undefined
  ...
  replayWorkAddedToOrderV1(event: WorkAddedToOrderV1) {
