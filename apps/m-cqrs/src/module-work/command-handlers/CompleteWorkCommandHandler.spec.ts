...
import { CompleteWorkCommand } from '../commands/index.js'
import { CompleteWorkCommandHandler } from './CompleteWorkCommandHandler.js'
import { WorkStatusChangedV1 } from '../events/index.js'
import { STATUS } from '../../constants/work.js'

describe('CompleteWorkCommandHandler', () => {
  describe('execute', () => {
    const events = [
    ...
    let handler: CompleteWorkCommandHandler
    ...
    beforeEach(() => {
      ...
      handler = new CompleteWorkCommandHandler(repository, publisher)
    })

    const testCases = [
      {
        description: 'should update aggregate, save and commit events',
        payload: new CompleteWorkCommand({
          id: '1'
        }),
        expected: events
      }
